...
{
    public static class CblasHelper
    {
        const string CblasEnumValuePrefix = "Cblas";
        const string CblasMethodPrefix = "cblas_";
        ...
        {
            return nativeName.Replace(CblasMethodPrefix, string.Empty);
        }

        public static string WrapEnumValue(string nativeValue)
        {
            return nativeValue.Replace(CblasEnumValuePrefix, string.Empty);
        }
