...
{
    public class LapackeMethodWrapper
    {
        readonly LapackeTypeWrapper m_wrapper;
        StringBuilder m_sb = new StringBuilder();

        public LapackeMethodWrapper()
            : this(new LapackeTypeWrapper())
        { }

        public LapackeMethodWrapper(LapackeTypeWrapper wrapper)
        {
        ...
        public string WrapMethod(Method method)
        {
            ...
            m_sb.AppendFormat("{0} {1}({2})", mgdReturnType, LapackeHelper.WrapMethodName(method.Name),
